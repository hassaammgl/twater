...
const MOCK_POSTS = [
  ...
  },
  {
    ...
    time: "5h",
    content:
      "Working on something exciting with React Native and Expo! Can't wait to share more details soon 👀",
    replies: 23,
    reposts: 8,
    likes: 156,
    views: 890,
  },
  {
    ...
    time: "1d",
    content:
      "The future of mobile development is here. Cross-platform frameworks are getting better every day.",
    replies: 67,
    reposts: 34,
    likes: 445,
    views: 2100,
  ...
  const renderHeader = () => (
    <View className="border-b border-gray-200 dark:border-gray-800">
      <View className="flex-row">
        ...
        >
          <Text
            className={`font-bold text-[15px] ${activeTab === "For you" ? "text-gray-900 dark:text-white" : "text-gray-500 dark:text-gray-400"}`}
          >
            For you
          </Text>
          {activeTab === "For you" && (
        ...
        >
          <Text
            className={`font-bold text-[15px] ${activeTab === "Following" ? "text-gray-900 dark:text-white" : "text-gray-500 dark:text-gray-400"}`}
          >
            Following
          </Text>
          {activeTab === "Following" && (
